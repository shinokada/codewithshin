<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="display:none">
	...
	<symbol viewBox="0 0 16 16" id="box-arrow-in-down"
		...
		/><path fill-rule="evenodd" d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708z" /></symbol
	>
...
<div class="grid grid-cols-2 grid-rows-2 gap-2">
	<div class="h-10 w-10">
		<svg class="h-full w-full">
			<use xlink:href="#arrows-expand" class="h-6 w-6" />
		</svg>
	</div>

	<div class="h-10 w-10">
		<svg class="h-full w-full">
			<use xlink:href="#bag-check" class="h-6 w-6" />
		</svg>
	</div>

	<div class="h-10 w-10">
		<svg class="h-full w-full">
			<use xlink:href="#box-arrow-in-down" class="h-6 w-6" />
		</svg>
	</div>

	<div class="h-10 w-10">
		<svg class="h-full w-full">
			<use xlink:href="#bus-front" class="h-6 w-6" />
		</svg>
	</div>
</div>
