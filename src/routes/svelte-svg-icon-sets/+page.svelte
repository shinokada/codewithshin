	...
	const listRunes = [
		{
			...
			description:
				'A collection of animated SVG icons for Svelte with customizable draw transitions, events, and accessibility features. hover/click animations, colors, sizes, and stroke widths.',
