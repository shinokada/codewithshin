<script lang="ts">
	...
	const apps = [
		...
		},
		{
			...
			badge: '27+ Languages',
			description:
				'Allowing users to learn and practice vocabulary in their target language. From commonly spoken languages like English, Spanish, and Mandarin to niche languages.',
...
<Slider
	title="Learning Apps"
	list={apps}
	cardClass="dark:bg-sky-900 hover:bg-gray-100 hover:dark:bg-sky-800 max-w-full sm:max-w-[300px] md:max-w-[350px] xl:max-w-[400px]"
