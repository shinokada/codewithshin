<script>
	import HeroSection from './utils/HeroSection.svelte';
	...
	const list = [
		...
		},
		{
			...
			description:
				'29 SVG Icon sets including Flowbite Svelte icons, Heroicons, Font Awesome icons, Bootstrap, and more.',
			static_badge: {
		...
		},
		{
			...
			path: '/terminal-tools',
			description:
				'Terminal Tools for macOS, and Linux including terminal radio, package manager, text effects, and more.',
			static_badge: {
...
<Section class="flex flex-col gap-8 sm:gap-12 lg:pt-24">
	<div class="flex flex-col items-center gap-4 sm:gap-4">
		<h2 class="text-3xl font-extrabold tracking-tight text-gray-900 lg:text-4xl dark:text-white">
			My Projects
		</h2>
		<p class="mx-auto max-w-3xl text-center text-xl font-normal text-gray-500 dark:text-gray-400">
