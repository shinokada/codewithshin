<script lang="ts">
  ...
  let { name, dir = '', path = '', thumnailSize, ...attributes } = $props<Props>();

  path = path.toLowerCase();
  dir = dir.toLowerCase();
</script>

<Card href="/docs/{dir}{path}/" padding="none" {...attributes} class="!max-w-none shadow-none hover:shadow-lg dark:hover:bg-gray-900 dark:hover:shadow-lg-light">
