...
<Section class="flex flex-col gap-8 sm:gap-12 lg:pt-24">
  ...
  {#if !expanded}
    <div class="w-full flex justify-center mb-4">
      <Button size="md" btnclass="whitespace-nowrap hover:text-primary-600 focus:text-primary-600" color="alternative" onclick={() => (expanded = true)}>View all components</Button>
    </div>
  {/if}
</Section>
