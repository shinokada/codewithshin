...
<div class="max-w-8xl mx-auto px-4 py-0 lg:px-20">
	<div class="flex flex-col gap-20">
		<div class="flex items-center gap-8">
			<div class="flex flex-col justify-start gap-10">
				<div class="flex flex-col gap-2 text-left align-text-top xl:gap-6">
					<h1
						class="mt-2 max-w-2xl text-4xl leading-none font-extrabold text-gray-900 lg:text-5xl dark:text-white"
					>
					...
					<p class="text-2xl leading-normal text-gray-500 xl:text-3xl dark:text-gray-400">
						Hi, I'm Shin, a programmer and technology enthusiast with a passion for sharing my
						knowledge and experience.
					</p>
					<div class="mt-4 justify-center sm:flex sm:justify-start md:mt-2">
						<div
							class="eading-normal relative w-full gap-1 text-xl text-gray-500 xl:text-2xl dark:text-gray-400"
						>
