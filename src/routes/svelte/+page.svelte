<script lang="ts">
	...
	const list = [
		...
		},
		{
			...
			npm_version: {
				packageName: 'svelte-lib-helpers',
				logo: 'svelte',
				color: 'blue',
				label: 'Svelte Lib Helpers'
			}
		}
	];
	...
	const listRunes = [
		...
		},
		{
			name: 'Flowbite Svelte Admin Dashboard',
			description:
				'A free and open-source UI admin dashboard components built with Flowbite Svelte for Svelte 5 Runes.',
		...
		},
		{
			...
			npm_version: {
				packageName: 'runes-meta-tags',
				logo: 'svelte',
				color: 'red',
				label: 'Runes Meta Tags'
			}
		},
		{
			...
			npm_version: {
				packageName: 'svelte-rune-highlight',
				logo: 'svelte',
				color: 'red',
				label: 'Svelte Rune Highlight'
			}
		},
		{
			name: 'Runes Webkit',
			description:
				'A collection of ready-to-use components for Svelte 5 Runes. Navbar, Footer, CodeWrapper, DocPage, HomeCards, IconPage, OnThisPage, Sidebar, TechInfo, and more.',
			path: 'https://runes-webkit.codewithshin.com/',
			npm_version: {
				packageName: 'runes-webkit',
				logo: 'svelte',
				color: 'red',
				label: 'Runes Webkit'
			}
		...
		{
			name: 'Svelte Shields',
			description: 'Shilds.io badges for Svelte Runes project.',
			path: 'https://svelte-shields.codewithshin.com/',
			npm_version: {
		...
		},
		{
			...
			description:
				'Moved to Flowbite Svelte. A UI library crafted for Svelte 5 Runes. Alert, Avatar, Badge, Button, Banner, Card, Checkbox, Dropdown, Input, Progress, Select, Skeleton, Spinner, Table, and more.',
