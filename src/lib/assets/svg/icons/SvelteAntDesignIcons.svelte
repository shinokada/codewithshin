...
<div class="grid grid-cols-2 grid-rows-2 gap-2">
	<div class="h-10 w-10">
		<svg class="svg_symbol">
			<use xlink:href="#alert" class="svg_alert" />
		</svg>
	</div>

	<div class="h-10 w-10">
		<svg class="svg_symbol">
			<use xlink:href="#car" class="svg_car" />
		</svg>
	</div>

	<div class="h-10 w-10">
		<svg class="svg_symbol">
			<use xlink:href="#dropbox" class="svg_dropbox" />
		</svg>
	</div>

	<div class="h-10 w-10">
		<svg class="svg_symbol">
			<use xlink:href="#info-circle" class="svg_info-circle" />
		</svg>
	</div>
</div>
