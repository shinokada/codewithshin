<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="display:none">
  <symbol viewBox="0 0 512 512" id="br"
    ><mask id="a"><circle cx="256" cy="256" r="256" fill="#fff" /></mask><g mask="url(#a)"
      ><path fill="#6da544" d="M0 0h512v512H0z" /><path fill="#ffda44" d="M256 100.2 467.5 256 256 411.8 44.5 256z" /><path
        fill="#eee"
  ...
  <symbol viewBox="0 0 512 512" id="ca"
    ><mask id="a"><circle cx="256" cy="256" r="256" fill="#fff" /></mask><g mask="url(#a)"
      ><path fill="#d80027" d="M0 0v512h144l112-64 112 64h144V0H368L256 64 144 0Z" /><path fill="#eee" d="M144 0h224v512H144Z" /><path
        fill="#d80027"
  ...
  <symbol viewBox="0 0 512 512" id="et"
    ><mask id="a"><circle cx="256" cy="256" r="256" fill="#fff" /></mask><g mask="url(#a)"
      ><path fill="#d80027" d="m0 345 255.7-31L512 345v167H0z" /><path fill="#ffda44" d="m0 167 258-40.7L512 167v178H0z" /><path fill="#6da544" d="M0 0h512v167H0z" /><circle
        cx="256"
        cy="256"
        r="122.4"
        fill="#0052b4"
...
<div class="grid grid-cols-2 grid-rows-2 gap-2">
  <div class="h-10 w-10">
    <svg class="h-full w-full">
      <use xlink:href="#br" class="h-6 w-6" />
    </svg>
  </div>

  <div class="h-10 w-10">
    <svg class="h-full w-full">
      <use xlink:href="#ca" class="h-6 w-6" />
    </svg>
  </div>

  <div class="h-10 w-10">
    <svg class="h-full w-full">
      <use xlink:href="#cn" class="h-6 w-6" />
    </svg>
  </div>

  <div class="h-10 w-10">
    <svg class="h-full w-full">
      <use xlink:href="#et" class="h-6 w-6" />
    </svg>
  </div>
</div>
