<svg
	...
	style="display:none"
>
	<symbol viewBox="0 0 640 512" id="anchor-lock"
		><path
		...
		/></symbol
	>
	<symbol viewBox="0 0 576 512" id="arrow-down-up-across-line"
		><path
		...
		/></symbol
	>
	<symbol viewBox="0 0 512 512" id="atom"
		><path
		...
		/></symbol
	>
	<symbol viewBox="0 0 512 512" id="baseball-bat-ball"
		><path
...
<div class="grid grid-cols-2 grid-rows-2 gap-2">
	<div class="h-10 w-10">
		<svg class="svg_symbol">
			<use xlink:href="#anchor-lock" class="svg_anchor-lock" />
		</svg>
	</div>

	<div class="h-10 w-10">
		<svg class="svg_symbol">
			<use xlink:href="#arrow-down-up-across-line" class="svg_arrow-down-up-across-line" />
		</svg>
	</div>

	<div class="h-10 w-10">
		<svg class="svg_symbol">
			<use xlink:href="#atom" class="svg_atom" />
		</svg>
	</div>

	<div class="h-10 w-10">
		<svg class="svg_symbol">
			<use xlink:href="#baseball-bat-ball" class="svg_baseball-bat-ball" />
		</svg>
	</div>
</div>
...
<style>
	...
	.svg_arrow-down-up-across-line {
		width: 576px;
		height: 512px;
	}
	.svg_atom,
	.svg_baseball-bat-ball {
		width: 512px;
		height: 512px;
	}
	.symbol-container {
