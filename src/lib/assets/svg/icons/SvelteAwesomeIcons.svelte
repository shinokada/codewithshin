...
<div class="grid grid-cols-2 grid-rows-2 gap-2">
  <div class="h-10 w-10">
    <svg class="h-full w-full">
      <use xlink:href="#anchor-lock" class="h-6 w-6" />
    </svg>
  </div>

  <div class="h-10 w-10">
    <svg class="h-full w-full">
      <use xlink:href="#arrow-down-up-across-line" class="h-6 w-6" />
    </svg>
  </div>

  <div class="h-10 w-10">
    <svg class="h-full w-full">
      <use xlink:href="#atom" class="h-6 w-6" />
    </svg>
  </div>

  <div class="h-10 w-10">
    <svg class="h-full w-full">
      <use xlink:href="#baseball-bat-ball" class="h-6 w-6" />
    </svg>
  </div>
</div>
