...
function _page($$payload) {
  ...
  const list = [
    ...
    },
    {
      ...
      npm_version: {
        ...
        logo: "svelte",
        color: "blue",
        label: "Svelte Google Materialdesign Icons"
      }
    },
    {
      name: "Svelte Heros",
    ...
    },
    {
      ...
      npm_version: {
        ...
        logo: "svelte",
        color: "blue",
        label: "Svelte Materialdesign Icons"
      }
    },
    {
      name: "Svelte Oct",
  ...
  $$payload.out += `<div class="mb-8 flex flex-col items-center gap-4 sm:gap-4"><h1>29 Svelte SVG Icon Sets</h1></div> `;
  Components($$payload, {
    componentData: mainWeb,
    colNum: 1,
    class: "mx-auto sm:max-w-96"
  });
  $$payload.out += `<!----> <div class="my-8 flex flex-col items-center gap-4 sm:gap-4"><h2>For Svelte 5/Runes projects</h2></div> `;
