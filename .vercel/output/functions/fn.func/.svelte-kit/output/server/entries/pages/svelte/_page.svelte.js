...
function _page($$payload) {
  ...
  $$payload.out += `<div class="mb-8 flex flex-col items-center gap-4 sm:gap-4"><h1>Svelte Libraries</h1> <h2>For Svelte 5/Runes projects</h2></div> `;
  Components($$payload, { componentData: listRunes });
  $$payload.out += `<!----> <div class="my-8 flex flex-col items-center gap-4 sm:gap-4"><h2>For Svelte 4/5 projects</h2></div> `;
  Components($$payload, { componentData: list });
  $$payload.out += `<!----> <div class="my-8 flex flex-col items-center gap-4 sm:gap-4"><h2>Demo and Starters</h2></div> `;
  Components($$payload, { componentData: demo });
  $$payload.out += `<!---->`;
}
export {
  _page as default
